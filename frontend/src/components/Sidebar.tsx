  ...
  return (
    <aside className="flex flex-col w-64 min-h-screen bg-gray-900 border-r border-gray-800">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-800">
        ...
        <div>
          <p className="text-white font-bold text-sm leading-tight">AntiFraud</p>
          <p className="text-gray-500 text-xs">iGaming Platform</p>
        </div>
      </div>

      {/* Navigation */}
      <nav className="flex-1 px-3 py-4 space-y-1">
        <p className="px-3 py-1 text-xs font-semibold text-gray-500 uppercase tracking-wider">Main</p>
        {navItems.map((item) => {
          const isActive =
            item.path === '/'
              ? location.pathname === '/'
      ...
      <div className="px-3 py-4 border-t border-gray-800">
        <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-gray-800">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-gray-500 text-xs capitalize">{user?.role ?? 'analyst'}</p>
          </div>
          <button
            onClick={logout}
            title="Logout"
